...
textDecode =  new TextDecoder('gbk');
function bufferDecodeText(in_buffer)
{
    return textDecode.decode(new Uint8Array(in_buffer))
}
...
module.exports = function (/*Buffer*/input) {
    ...
    return {
        get entryName () { return bufferDecodeText(_entryName); },
        ...
        get name () { var n = bufferDecodeText(_entryName); return _isDirectory ? n.substr(n.length - 1).split("/").pop() : n.split("/").pop(); },
